...
namespace TradingBot.Backend.Gateway.API.Middlewares;
...
public class ErrorHandlingMiddleware
{
    ...
    private static string ParseToMessage(string message)
    {
        ...
        {
            result = Defaults.Error.DbException.Duplicate;
        }
        else if (message.Contains("REFERENCE constraint \"FK_"))
        {
            ...
            return $"{Defaults.Error.DbException.ReferenceConstraint}|{first}";
        }
        return result;
    }
}