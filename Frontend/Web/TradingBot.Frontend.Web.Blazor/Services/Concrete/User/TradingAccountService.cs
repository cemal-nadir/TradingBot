...
namespace TradingBot.Frontend.Web.Blazor.Services.Concrete.User
{
	...
	{
		public TradingAccountService(IHttpClientService client, Env env,ProtectedLocalStorage localStorage) : base(client, $"{env.GatewayUrl}{ServiceDefaults.User.UserService}/TradingAccount",localStorage)
		{
		}
